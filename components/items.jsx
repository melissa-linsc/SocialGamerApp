export const items = [
  {
    ...
    description:
      "Start your own cult in a land of false prophets, venturing out into the diverse and mysterious region to build a loyal community of woodland followers and spread your word to become the one true cult.",
    platforms: [
      { name: "Nintendo Switch", url: "https://www.nintendo.com/switch/" },
      { name: "Playstation", url: "https://www.playstation.com/" },
      { name: "XBox", url: "https://www.xbox.com/" },
      { name: "PC/Laptop", url: "https://www.steampowered.com/" },
    ],
